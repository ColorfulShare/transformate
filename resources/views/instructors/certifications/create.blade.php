...
@section('content')
	<div class="uk-container">
		...
		<div class="uk-card-default">
			<form class="uk-form-horizontal uk-margin-large" action="{{ route('instructors.certifications.store') }}" method="POST" enctype="multipart/form-data">
				@csrf
		        <div class="uk-card-header uk-text-center">
		            <h4>Crear Certificación</h4>
		        </div> 
		        ...
		        <div class="uk-card-footer uk-text-right">
		        	<button type="submit" class="uk-button uk-button-danger">Crear Certificación</button>
		        </div>
	        </form>
	    </div>
	</div>
