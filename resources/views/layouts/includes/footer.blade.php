    ...
    <div class="uk-column-1-2@s uk-column-1-2@m uk-column-1-4@l">
        ...
        <div class="uk-text-white">
            ...
            <ul class="social-network social-circle d-flex">
               <li><a href="https://www.facebook.com/TransformatePro/" target="_blank" class="icoLinkedin" title="Linkedin"><i class="fab fa-linkedin"></i></a></li><br>
        ...
        <div class="uk-text-white">
            <span style="font-size: 18px; font-weight: 500;">Contacto</span><br>
