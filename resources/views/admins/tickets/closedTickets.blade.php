...
@section('content')
    <div class="admin-content-inner"> 
        <div class="uk-flex-inline uk-flex-middle uk-margin-small-bottom"> 
            ...
            <h4 class="uk-margin-remove"> Listado de Tickets Cerrados</h4>                     
        </div>  
                ...
                <table id="datatable"> 
                    <thead> 
                        <tr class="uk-text-small uk-text-bold"> 
                            ...
                            <th class="uk-text-center">Fecha de Solución</th>
                    ...
                    <tbody> 
                        @foreach ($tickets as $ticket)
                            <tr>      
                                ...
                                <td class="uk-text-center">{{ date('d-m-Y H:i A', strtotime("$ticket->resolved_at -5 Hours")) }}</td>
                                <td class="uk-text-center">
