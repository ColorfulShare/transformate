...
@section('content')
   <div class="uk-child-width-1-2@xl uk-child-width-1-2@l uk-child-width-1-2@m uk-child-width-1-1@s" uk-grid style="background-color: white;">
      <div class="course-details-div">
         <a href="{{ route('admins.podcasts.index') }}" class="link-back-to-courses">Volver a T-Libros</a>
      ...
      <div class="course-content-div">
         ...
         <div class="course-accordion">
            ...
            <div style="padding-top: 30px;">
               <a href="{{ route('admins.podcasts.index') }}" class="link-back-to-courses"><b>Volver a T-Libros</b></a>
            </div>
         </div>
      </div>
               ...
               <div id="ratings-content" uk-scrollspy="target: > div; cls: uk-animation-slide-bottom; delay: 500" style="height: 500px; overflow-y: scroll;">
                  <div style="height: auto;">
                     ...
                     @if ($totalValoraciones > 2)
                        <div class="uk-text-center" style="padding-top: 10px;"><a href="javascript:;" class="link-back-to-courses" id="link-show-more" onclick="showMoreRatings();" data-route="{{ route('admins.ratings.show-more', [$podcast->id, 2, 'podcast']) }}"><b><i class="fas fa-search-plus"></i> Ver más...</b></a></div>
                     @endif
                  </div>
              </div>
