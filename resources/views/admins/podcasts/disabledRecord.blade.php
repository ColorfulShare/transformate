...
@section('content')
    <div class="admin-content-inner"> 
        <div class="uk-flex-inline uk-flex-middle uk-margin-small-bottom"> 
            ...
            <h4 class="uk-margin-remove"> Podcasts Deshabilitados</h4>                          
        </div>  
                                ...
                                <td class="uk-flex-inline uk-text-center"> 
                                    ...
                                    @if (Auth::user()->profile->podcasts == 2)
                                        <form action="{{ route('admins.podcasts.change-status') }}" method="POST">
                                            ...
                                            <button class="uk-icon-button uk-button-danger btn-icon" uk-icon="icon: refresh;" uk-tooltip="Restaurar"></button>
                                        </form>       
                                    @endif                     
                                </td>                                 
                            </tr>   
