        ...
        <nav class="uk-navbar-container uk-margin-medium-bottom" uk-navbar style="padding-top: 20px; padding-bottom: 40px;">
            ...
            <div class="uk-navbar-right">
                <ul class="uk-navbar-nav">
                    ...
                    <li class="uk-active" style="border-right: 1px solid #000;"><a href="{{ route('admins.podcasts.reports.students') }}">Estudiantes</a></li>
                    ...
                    <tbody> 
                        @foreach ($podcasts as $podcast)
                            <tr>                                 
                                ...
                                <td class="uk-text-center">{{ $podcast->students_count }}</td> 
                                <td class="uk-flex-inline uk-text-center"> 
                                    <a href="{{ route('admins.podcasts.reports.show-students', $podcast->id) }}" class="uk-icon-button uk-button-success" uk-icon="icon: file-text;" uk-tooltip="Ver Reporte"></a>              
                                </td>                                 
                            </tr>   
                        @endforeach  
                    </tbody>                         
