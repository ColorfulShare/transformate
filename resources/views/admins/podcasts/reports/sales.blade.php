    ...
    <div class="admin-content-inner"> 
        <nav class="uk-navbar-container uk-margin-medium-bottom" uk-navbar style="padding-top: 20px; padding-bottom: 40px;">
            ...
            <div class="uk-navbar-right">
                <ul class="uk-navbar-nav">
                    <li class="uk-active" style="border-right: 1px solid #000;"><a href="{{ route('admins.podcasts.reports.sales') }}">Ventas</a></li>
                    <li style="border-right: 1px solid #000;"><a href="{{ route('admins.podcasts.reports.students') }}">Estudiantes</a></li>
                    <li><a href="{{ route('admins.podcasts.reports.ratings') }}">Valoraciones</a></li>
                </ul>
            </div>
        </nav> 
        ...
        <div class="uk-flex-inline uk-flex-middle uk-margin-small-bottom"> 
            ...
            <h4 class="uk-margin-remove"> Reporte de Compras</h4>                          
        </div>  
                    ...
                    <tbody> 
                        @foreach ($podcasts as $podcast)
                            <tr>                                 
                                ...
                                <td class="uk-text-center">{{ $podcast->purchases_count }}</td> 
                                <td class="uk-flex-inline uk-text-center"> 
                                    <a href="{{ route('admins.podcasts.reports.show-sales', $podcast->id) }}" class="uk-icon-button uk-button-success" uk-icon="icon: file-text;" uk-tooltip="Ver Reporte"></a>              
                                </td>                                 
                            </tr>   
                        @endforeach  
                    </tbody>                         
