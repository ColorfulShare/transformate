...
@section('content')
    <div class="admin-content-inner"> 
        <div class="uk-flex-inline uk-flex-middle uk-margin-small-bottom"> 
            ...
            <h4 class="uk-margin-remove"> Cursos Más Vendidos</h4>                          
        </div>  
                        ...
                        @foreach ($cursos as $curso)
                            <tr>                                 
                                ...
                                <td class="uk-flex-inline uk-text-center"> 
                                    <a href="{{ route('admins.courses.reports.show-sales', $curso->course->id) }}" class="uk-icon-button uk-button-success" uk-icon="icon: file-text;" uk-tooltip="Ver Reporte"></a>              
                                </td>                                 
                            </tr>   
                        @endforeach  
                    </tbody>                         
