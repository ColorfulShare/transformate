...
@section('content')
    <div class="admin-content-inner"> 
        <div class="uk-flex-inline uk-flex-middle uk-margin-small-bottom"> 
            ...
            <h4 class="uk-margin-remove"> Valoraciones por Curso</h4>                          
        </div>                 
                        ...
                        @foreach ($valoraciones as $valoracion)
                            <tr>                                                                 
                                <td class="uk-text-center">
                                    ...
                                    @else
                                        <img class="uk-preserve-width uk-border-circle user-profile-small" src="{{ asset('uploads/images/users/avatar.png') }}" width="50">
                                    @endif
                                </td>
                                <td class="uk-text-center">
                                    @if ($valoracion->user_id != 0)
