    ...
    <div class="admin-content-inner"> 
        ...
        <nav class="uk-navbar-container uk-margin-medium-bottom" uk-navbar style="padding-top: 20px; padding-bottom: 40px;">
            ...
            <div class="uk-navbar-right">
                <ul class="uk-navbar-nav">
                    <li style="border-right: 1px solid #000;"><a href="{{ route('admins.certifications.reports.sales') }}">Ventas</a></li>
                    <li style="border-right: 1px solid #000;"><a href="{{ route('admins.certifications.reports.students') }}">Estudiantes</a></li>
                    <li class="uk-active"><a href="{{ route('admins.certifications.reports.ratings') }}">Valoraciones</a></li>
                </ul>
            </div>
        </nav>
                    ...
                    <tbody> 
                        @foreach ($certificaciones as $certificacion)
                            ...
                            <tr>                                 
                                ...
                                <td class="uk-text-center">{{ $certificacion->category->title }} <br>({{ $certificacion->subcategory->title }})</td> 
                                <td class="uk-text-center">
    					            ...
    					            ({{ number_format($certificacion->promedio, 2) }})
                                </td> 
                                <td class="uk-flex-inline uk-text-center"> 
                                    <a href="{{ route('admins.certifications.reports.show-ratings', $certificacion->id) }}" class="uk-icon-button uk-button-success" uk-icon="icon: file-text;" uk-tooltip="Ver Reporte"></a>              
                                </td>                                 
                            </tr>   
                        @endforeach  
                    </tbody>                         
