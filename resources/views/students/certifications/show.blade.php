            ...
            <div class="uk-width-1-3@m">
               ...
               <div class="hero__purchase-actions">
                  ...
                  <div class="uk-hidden@m">
                     <div class="hero__price">CO$ {{ number_format($certificacion->price, 0, ',', '.') }} </div>
                     <span class="t-price-before">50% Dto. CO$ {{ number_format($certificacion->price*2, 0, ',', '.') }}</span>
                     <br>
                  </div>
   ...
   <div id="preview" uk-modal>
      <div class="uk-modal-dialog"> 
         ...
         <div class="uk-modal-footer uk-text-right"> 
            <a class="btn btn-quaternary btn-lg btn-block" href="{{ route('students.shopping-cart.store', [$certificacion->id, 'certificacion']) }}">
               <i class="fa fa-shopping-cart"></i>
               <span class="btn-label">Añadir al Carrito</span>
            </a>
         </div>
