                ...
                <div class="uk-width-2-3">
                    <article class="paper">
                        <header class="paper__header paper__header--topic">
                            <h1><a href="{{ route('students.discussions.show', [$discusion->slug, $discusion->id]) }}">{{ $discusion->title }}</a></h1>
                            <p class="meta">
                    ...
                    <div id="new_comment">
                        <div class="comment-unit comment-unit--you">
                            <div class="comment-unit__head">
                             ...
                             <form action="{{ route('students.discussions.store-comment') }}" method="POST">
                                @csrf
