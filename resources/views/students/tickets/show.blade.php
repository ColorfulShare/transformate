...
@section('content')
    <div class="uk-container padding-top">
            ...
            <div class="uk-card-header uk-text-bold">
                ...
                @if ($ticket->status != 3)
                    <div class="uk-align-right uk-text-right">
                        <a class="uk-button uk-button-danger" href="{{ route('students.tickets.close', $ticket->id) }}">Cerrar Ticket</a>
                    </div>
                @endif
            </div>              
                ...
                @if ($ticket->status != 3)
                    <div class="uk-width-1-1"> 
                        <div class="uk-card-small uk-card-default"> 
                            ...
                            <form action="{{ route('students.tickets.reply') }}" method="POST"> 
                                @csrf
